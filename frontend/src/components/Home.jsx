        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
          ...
          {nfts.map((nft, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#101010] rounded-2xl overflow-hidden border border-cyan-800/30 shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] transform hover:-translate-y-2 transition-all duration-500"
            >
              <img
                src={
